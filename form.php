    ...
    <div class="container mt-5">
        ...
        <form action="proses.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="harga" min="0" name="Harga" required="required">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="stok" min="0" name="stok" required="required">
            </div>
